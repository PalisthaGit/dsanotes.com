...
import { KEY_TO_SLUG } from "@/lib/sorting-seo";
...
export default function SortingVisualizer({
  ...
  const handleAlgorithmChange = useCallback(
    (algo: string) => {
      ...
      resetArray();
      setAlgorithm(algo);
      const slug = KEY_TO_SLUG[algo];
      if (slug) router.push(`/visualizer/sorting/${slug}`);
    },
    [handleStopSorting, resetArray, setAlgorithm, router],
  );
    ...
    <div style={{ background: "#f2f4f7", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "0 48px 48px" }}>
        ...
        >
          ...
          >
            {[
              { color: "#2a3350", border: "1.5px solid #3a4460", label: "Unsorted" },
              { color: "#2a3350", border: "1.5px solid #6FB5FF", label: "Comparing" },
              { color: "#fb923c", border: undefined, label: "Swapping" },
              { color: "#22c55e", border: undefined, label: "Sorted" },
